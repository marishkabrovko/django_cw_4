...
urlpatterns = [
    ...
    path(
        "update/recipient/<int:pk>/",
        RecipientUpdateView.as_view(),
        name="recipient_update",
    ),
    path(
        "delete/recipient/<int:pk>/",
    ...
    path(
        "update/message/<int:pk>/", MessageUpdateView.as_view(), name="message_update"
    ),
    path(
        "delete/message/<int:pk>/", MessageDeleteView.as_view(), name="message_delete"
    ),
    ...
    path(
        "update/mailing/<int:pk>/", MailingUpdateView.as_view(), name="mailing_update"
    ),
    path(
        "delete/mailing/<int:pk>/", MailingDeleteView.as_view(), name="mailing_delete"
    ),
    path("mailing_send/<int:pk>/", MailingSendView.as_view(), name="mailing_send"),
    path(
        "mailing_report/<int:pk>/", MailingReportView.as_view(), name="mailing_report"
    ),
